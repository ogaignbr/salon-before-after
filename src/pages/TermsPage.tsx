      ...
      <div className="flex-1 overflow-y-auto px-1 pb-2">
        <div className="rounded-[20px] border border-[#A8DDE5]/35 bg-[rgba(255,255,255,0.94)] p-5 text-[11px] leading-relaxed text-[#1B3A5C] shadow-[0_12px_32px_rgba(60,140,170,0.12)] backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/45 dark:text-slate-300 dark:shadow-[0_20px_42px_-30px_rgba(30,46,105,0.9)]">
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第1条（適用）</h2>
            <p>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第2条（サービス内容）</h2>
            <p>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第3条（利用者の責任）</h2>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第4条（画像データの取扱い）</h2>
            <p>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第5条（禁止事項）</h2>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第6条（免責事項）</h2>
            <ul className="list-disc pl-4 space-y-0.5">
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第7条（サービスの変更・停止）</h2>
            <p>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第8条（規約の変更）</h2>
            <p>
          ...
          <section className="mt-4 space-y-1.5">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第9条（準拠法・管轄）</h2>
            <p>
          ...
          <section className="mt-5 rounded-[16px] border border-[#A8DDE5]/30 bg-[#F0FBF8]/70 p-4 dark:border-cyan-300/20 dark:bg-cyan-500/10">
            <h2 className="text-xs font-black text-[#3DC4A8] dark:text-cyan-300">第10条（解約について）</h2>
            <p className="mt-1 text-[11px] leading-relaxed text-[#1B3A5C]/85 dark:text-cyan-100/85">
            ...
            {user ? (
              <button
                ...
                className="sheen-wrap mt-3 w-full rounded-[10px] border border-[#5BB5E7]/40 bg-[linear-gradient(135deg,#3DC4A8_0%,#48B8CB_50%,#5BB5E7_100%)] px-3 py-2.5 text-xs font-bold text-white shadow-[0_8px_18px_rgba(70,160,200,0.24)] transition-all hover:brightness-105 active:scale-[0.99]"
              >
                解約手続きへ進む
              </button>
            ) : (
              <p className="mt-2 text-[10px] text-[#3DC4A8] dark:text-cyan-300">解約はログイン後に行えます。</p>
            )}
          </section>
        </div>
      </div>
